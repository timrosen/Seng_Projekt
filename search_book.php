	...
	<body class="body_search"> 
        ...
        <nav id="mainnav">
            ...
            ?>
                        ...
                        <li><a href="Booklist.php">Bookist</a></li>
        ...
        */
        if(isset($_POST['submit_search'])){
            /*
                Die Datenbank (Buchtabelle) wird nach Übereinstimmungen durchsucht
            */
            $search = mysqli_real_escape_string($conn, $_POST['search']); 
            $sql = "SELECT * FROM book WHERE bookTitel LIKE '%$search%'"; // Tabelle wird durchsucht
            ...
            if($queryResult > 0){
                ...
                <?php   
                    /*
                        ...
                        Buch können über "Weiterlesen" erreicht werden.
